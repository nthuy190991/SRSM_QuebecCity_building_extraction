...
![SRSM results overlapped on z-image (tile 4190)](https://github.com/nthuy190991/SRSM_QuebecCity_building_extraction/blob/master/examples/4190_on_zimg.png){:width="400px"}
![SRSM results overlapped on orthoimage (tile 4190)](https://github.com/nthuy190991/SRSM_QuebecCity_building_extraction/blob/master/examples/4190_on_opt_img.png){:width="400px"}
